    ...
    <>
      ...
      <main>
        ...
        <div>
          ...
          <img src="/modulo_bluetooth.jpg" alt="imagem do módulo bluetooth" />
        </div>
        ...
        <div>
          ...
          <img src="/capacitores.jpg" alt="imagem do capacitor" />
        </div>
        ...
        <div>
          ...
          <img src="/jumpers.jpg" alt="imagem dos jumpers" />
        </div>
        ...
        <div>
          ...
          <img src="/quartetos-led.jpg" alt="imagem do led" />
        </div>
        ...
        <div>
          ...
          <img src="/mangueira.jpg" alt="imagem da mangueira" />
        </div>
        ...
        <div>
          ...
          <img src="/micro_servo.jpg" alt="imagem do micro servo motor" />
        </div>
        ...
        <div>
          ...
          <img src="./mini-bomba-dagua.png" alt="imagem da bomba de água" />
        </div>
        ...
        <div>
          ...
          <img src="./Módulo-Relé.jpg" alt="imagem do módulo relé" />
        </div>
        ...
        <div>
          ...
          <img src="./placa uno.webp" alt="imagem da placa uno" />
        </div>
        ...
        <div>
          ...
          <img src="./protoboaard.jpg" alt="imagem da protoboard" />
        </div>
        ...
        <div>
          ...
          <img src="./conector.jpg" alt="imagem do conector" />
        </div>
        <div>
          ...
          <img src="./bateria.jpg" alt="imagem da bateria" />
        </div>
